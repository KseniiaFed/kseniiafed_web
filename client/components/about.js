    ...
    <div>
      <div className="px-12 pt-8 pb-16 w-full flex flex-col space-y-12 justify-center tracking-wide">
        <div className="relative flex flex-col">
          <div className="text-4xl tracking-wider text-gray-800">
            <h1 className="p-12 self-center">About Us</h1>
          </div>
          <div className="text-gray-900 text-xl p-10 rounded-lg shadow-lg max-w-screen-lg">
            <p>
              {' '}
              Skillnet is set up by ut perspiciatis unde omnis iste natus error sit voluptatem
        ...
        <div className="relative flex flex-col space-y-2">
          <h3 className="p-12 text-2xl text-gray-900">Infographics</h3>
        ...
        <div className="relative flex flex-col space-y-2">
          ...
          <div className="p-10 text-gray-900 text-xl rounded-lg shadow-lg">
            1.CEO 2.Board member 3.Industry
          </div>
        </div>
      </div>
      <div className="relative flex flex-col space-y-2 bg-about-us bg-cover bg-center">
        <div className="bg-black bg-opacity-50 px-16 pt-16 pb-32">
          <h3 className="py-6 px-8 text-2xl text-white">Our mission</h3>
